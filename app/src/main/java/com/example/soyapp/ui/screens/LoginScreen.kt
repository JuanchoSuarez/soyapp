...
import com.example.soyapp.ui.utils.FormularioGeneral
...
fun BodyLoginScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        BotonGeneral(
            texto = stringResource(R.string.ingresar),
            onClick = {
                Log.d("LoginScreen", "Usuario: $textoUsuario")
                Log.d("LoginScreen","Contrasena: $textoContrasena")
            }
        )
    }
}
